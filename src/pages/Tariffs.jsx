  ...
  useEffect(() => {
    const fetchTariffs = async () => {
      try {
        ...
        const response = await axios.get('https://meistermode-carsharing-backend-7481.twc1.net:8000/api/tariffs', { headers });
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            выберите идеальный тариф для вашего комфортного передвижения, и в путь!
          </p>
        </div>
